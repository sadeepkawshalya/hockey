                                ...
                                if (data2.data.regions[0].rows.length == 0) {
                                    ...
                                    for (let h = 0; h < data2.data.regions[0].rows.length; h++) {
                                        ...
                                        if (parseInt(datt[j].link.ids[0]), data2.data.regions[0].rows[h].cells[1].text[0].includes('Torschütze')) {
                                            ...
                                            if (data2.data.regions[0].rows[h].cells[2].text[0].replaceAll(' ', '') == datt[j].cells[4].text[0].replaceAll(' ', '') || data2.data.regions[0].rows[h].cells[2].text[0].replaceAll(' ', '').includes(datt[j].cells[4].text[0].replaceAll(' ', '')) || datt[j].cells[4].text[0].replaceAll(' ', '').includes(data2.data.regions[0].rows[h].cells[2].text[0].replaceAll(' ', ''))) {
                                                console.log('t1', parseFloat(jk[0]));
                                                const sqlInm = `UPDATE ${se}_table SET t1_60 = "${team1_val[0][0]}",t1_55 = "${team1_val[1][0]}",t1_50 = "${team1_val[2][0]}",t1_45 = "${team1_val[3][0]}",
